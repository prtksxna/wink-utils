...
utilities.stats.streaming.min = function () {
  var items = 0;
  var min = Infinity;
...
utilities.stats.streaming.max = function () {
  var items = 0;
  var max = -Infinity;
  var methods = Object.create( null );
...
utilities.stats.streaming.mean = function () {
  var mean = 0;
  var min = Infinity;
  var max = -Infinity;
  var items = 0;
...
// computations.
utilities.stats.streaming.countCats = function ( ) {
  var methods = Object.create( null );
  ...
  methods.buildFT = function () {
    var vf = utilities.stats.streaming.vitalFew();
    var vfr;
